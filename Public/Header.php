...
if ($page == 1) {
    ...
    echo '<a href="List.php" class="menu-item">Список предложений</a>';
}
if ($page == 2) {
    echo '<p class="menu-item_state_active">Поиск</p>';
} else {
    echo '<a href="Search.php" class="menu-item">Поиск</a>';
}
if ($page == 3) {
    echo '<p class="menu-item_state_active">Контакты</p>';
} else {
    echo '<a href="Contacts.php" class="menu-item">Контакты</a>';
}
if ($page == 4) {
    echo '<p class="menu-item_state_active">Войти</p>';
} else {
    echo '<a href="Auth.php" class="menu-item">Войти</a>';
}
if ($page == 5) {
    echo '<p class="menu-item_state_active">На карте</p>';
} else {
    echo '<a href="Onmap.php" class="menu-item">На карте</a>';
}
?>    
        </div>
